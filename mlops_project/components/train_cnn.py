...
def train_cnn_category(
    ...
    history_cnn_agg = train_model_wrapper(model, 'cnn', X_train, y_train, X_val, y_val, epochs=60, optimized=True)
    ...
    plot_training_history(history_cnn_agg, "CNN_Model_aggregated", plots_dir)


    os.makedirs(model_output, exist_ok=True)

    model_filename = f"cnn_model_h{horizon}.keras"
